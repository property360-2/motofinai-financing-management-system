"""
Django settings for DC Financing Corporation project.
...
MIDDLEWARE = [
    ...
    "motofinai.apps.core.middleware.ExceptionHandlingMiddleware",
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@dcfinancingcorp.com")
